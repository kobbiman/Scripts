...
network --device=eth0 --bootproto=static --ip=79.143.81.29 --netmask=255.255.255.248 --gateway=79.143.81.25 --nameserver=80.84.58.27 --noipv6 --hostname=$$$
...
echo "sicash-vm3.sicashapp.net" > /etc/hostname
echo .
cat > /etc/hosts << EOF
127.0.0.1       localhost
79.143.81.29   sicash-vm3.sicashapp.net     sicash-vm3
